...
$("[data-add-snippet").click(function(){
    ...
    switch(component) {
        ...
        case "subwayNavigationStep":
            // console.log(preview.querySelector('main'))
            let firstElmHTML = preview.querySelector('main').firstElementChild.outerHTML;
            preview.querySelector('main').firstElementChild.outerHTML = snippets[component];
            output.value = output.value.replace(firstElmHTML, snippets[component]);
            triggerWET();
            break;
        default:
          // code block
    ...
    update(output.value);    
    // document.getElementById('templator-'+componentID).scrollIntoView();
})
...
document.getElementById('alert-popup-button').onclick = function(){
    let alert = document.getElementById('alertType').value;
    console.log(alert);
}