(function () {
  ...
  // This mobile experiment opens the complete navigation on every invocation.
  function expandAllStepsInSticky() {
    ...
    var list = document.getElementById("pr-steplist");
