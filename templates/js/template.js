          ...
          <div class="row">
            <div class="col-md-12">
              <ul class="list-inline mrgn-bttm-0">
                <li>
                  <a lang="fr" href="`+ pageConstants.alternateLanguageURL + `">
...
const metaElements = document.createElement('template');
...
document.getElementById('pageConstants').insertAdjacentHTML('afterend', metaElements.innerHTML);

const dateModifiedTemplate = document.createElement('template');

dateModifiedTemplate.innerHTML = `
<section class="pagedetails">
    <h2 class="wb-inv">Page details</h2>
    <div class="pft"></div>
        <dl id="wb-dtmd">
    <dt>Date modified:</dt>
    <dd><time property="dateModified">`+ pageConstants.dateModified + `</time></dd>
</dl>
</section>
`;

document.getElementsByTagName('main')[0].append(dateModifiedTemplate.content);
